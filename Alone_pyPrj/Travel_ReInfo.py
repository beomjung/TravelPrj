...
import requests
import json
def Travel_reInfo(contentId, contentTypeId):
    ...
    params ={'serviceKey' : apiKey, 'numOfRows' : '10', 'pageNo' : '1', 'MobileOS' : 'ETC',
             'MobileApp' : 'AppTest', 'contentId' : contentId, 'contentTypeId' : contentTypeId, '_type': 'json' }
    res_dict = {}
...
def travel_listReInfo(contentId, contentTypeId):
    url = 'http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailInfo'
    apiKey = "MH5eq4rf03BY2MEb3ITxAZ9zg6KKHZUX1DJH/ud0+wS9I1anpXtyG8TZ6JOL/Rlv+xMZjQWPyh0BB7MwIFZEqA=="
