      ...
      <div class="row">
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            ...
            <div class="card-body">
              <form role="form" class="text-start" action="/user/UserFindIdProc" method="post">
                ...
                <p class="mt-4 text-sm text-center">
                  <a href="/user/findPwd" class="text-primary text-gradient font-weight-bold" style="margin-right: 20px;">비밀번호 찾기</a>
