      ...
      <div class="row">
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            ...
            <div class="card-body">
              <form role="form" class="text-start" action="/user/UserDeleteProc" method="post">
                   <h5>정말 탈퇴하시겠습니까?</h5>
                   <h8>탈퇴하시려면 "탈퇴하겠습니다"를 입력해 주세요</h8>
                   <br><br><br><br><br>
                  <div class="input-group input-group-outline mb-3">
                    <label class="form-label">탈퇴하겠습니다</label>
                    <input type="text" name="auth_text" class="form-control">
                  </div>
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2"  style="background-image:  linear-gradient(195deg, #49a3f1 0%, #49a3f1 100%); box-shadow: 0 4px 20px 0 rgb(0 0 0 / 14%), 0 7px 10px -5px rgb(245 236 239 / 40%) !important;">확인</button>
                </div>
              </form>
            </div>
          </div>
